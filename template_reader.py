...
PW_LAYER_MODULE_HEADER_TEMPLATE      = os.path.join(TEMPLATE_DIRECTORY, "pw_layer_module_header.txt")
...
MIF_TEMPLATE                = os.path.join(TEMPLATE_DIRECTORY, "MIF_template.txt")
ROM_INST_TEMPLATE                = os.path.join(TEMPLATE_DIRECTORY, "rom_inst.txt")
